		...
		<div className="min-h-screen flex flex-col bg-background text-foreground">
			...
			<main className="flex flex-1 flex-col items-center justify-center px-4 py-16 text-center sm:py-24">
				...
				<p className="mt-6 max-w-xl text-lg text-muted-foreground sm:text-xl">
					Graba tu pantalla y cámara en segundos. Sin instalación, desde el
					navegador. Descarga al instante.
				</p>
				<div className="mt-10">
					<LandingAuthCTA />
				</div>
			...
			<section className="border-t border-border/50 bg-muted/30 py-16">
				<div className="mx-auto max-w-6xl px-4">
					...
					<p className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
						Comparte pantalla, cámara y micrófono. Recorta el video si te sobra
						el inicio o el final. Todo en el navegador, sin instalar nada.
					</p>
					<ul className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
						<li className="rounded-xl border border-border bg-card p-6 shadow-sm">
							...
							<p className="mt-2 text-sm text-muted-foreground">
								Graba la pantalla con tu cámara en un círculo ajustable. Activa
								o desactiva micrófono y cámara al gusto.
							</p>
						</li>
						<li className="rounded-xl border border-border bg-card p-6 shadow-sm">
							<div className="flex h-10 w-10 items-center justify-center rounded-lg bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400">
							...
							<p className="mt-2 text-sm text-muted-foreground">
								Quita el inicio o el final del video sin salir de la app. Varias
								versiones y siempre puedes volver al original.
							</p>
						</li>
						<li className="rounded-xl border border-border bg-card p-6 shadow-sm">
							<div className="flex h-10 w-10 items-center justify-center rounded-lg bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400">
							...
							<p className="mt-2 text-sm text-muted-foreground">
								Descarga en WebM o, si lo prefieres, en MP4. Todo se procesa en
								tu navegador, sin subir el video a ningún servidor.
							</p>
						</li>
					</ul>
